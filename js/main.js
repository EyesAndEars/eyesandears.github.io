...
var smooth_scroll_to = function(element, target, duration) {
    ...
    return new Promise(function(resolve, reject) {
        ...
        var scroll_frame = function() {
            ...
            console.log("NOW: "+now+" | end_time: "+end_time);
            ...
            if (element.scrollTop === previous_top && element.scrollTop !== frameTop) {
                console.log("scrollTop: "+element.scrollTop+" | previous_top: "+previous_top+" | frameTop: "+frameTop);
                resolve();
                return;
            }
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    document.getElementById("involvedButton").addEventListener('click', function(e) {
        e.preventDefault();
        let y1 = document.getElementById('involved').getBoundingClientRect().top
        let y2 = document.body.getBoundingClientRect().top
